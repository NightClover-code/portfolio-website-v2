const Content = () => {
  return (
    <div>
      ...
      <p>
        Ever since I started my web development journey, I like to stay busy and
        spend most of my days taking my skills to the next-level.
      </p>
      <p>
        If you need a <span>custom-made</span> website, an engaging landing page
        for your business, or a very complex web application idea:
      </p>
      <p>
